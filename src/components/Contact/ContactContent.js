...
export default function ContactContent() {
  return (
    <div className="pt-10">
      ...
      <p className="font-bold text-4xl md:text-6xl my-4 text-green-three rubik"> CONTÁCTANOS</p>
        <p className="text-lg md:text-2xl text-orange-one font-josefin-sans">
          Nos gustaría conocer tus dudas
        </p>
      ...
      <div className="flex flex-wrap gap-10 my-10 text-center mx-10 place-content-center">
        <Card className="text-orange-one w-96 mb-6 max-w-full">
            <p className="mb-4 ">
                ...
                <span className="text-base md:text-2xl">55 1490 7030</span>
            </p>
        </Card>
